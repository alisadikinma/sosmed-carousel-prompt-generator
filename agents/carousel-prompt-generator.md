...
|---------|-----------|-------------------|
| **Human figure in B-Roll** | Scene involves visible human(s) | "Slide N shows [description]. Should this use your face (creator) or stay as anonymous figure?" |
...
- [ ] All slides have text rendered in-image (gradient zone)
...
- Character limits: IG ≤2200, TikTok ≤4000, LinkedIn ≤3000
