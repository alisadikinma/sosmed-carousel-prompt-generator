...
- **SWIPE FOR MORE**: "GESER UNTUK LANJUT >" rendered in-image on all slides except CTA, positioned directly beneath headline (20-30% engagement boost)
...
- **Bahasa Subtitle Color**: Bahasa subtitle line below main headline MUST be in **accent color** (not white). Creates visual hierarchy between main headline and translation
...
5. **Caption copywriting** — auto-generated for all 4 platforms with every carousel (Bahasa default)
