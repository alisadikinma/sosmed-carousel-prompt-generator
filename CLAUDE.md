...
- **Watermark**: @handle watermark **center of image, 30% opacity, below brand icon** on all slides. For split-panel comparison (A vs B): watermark **on the vertical divider line**
...
|---------|-------|-------------|
| Brand icon | **Center of image, above watermark** | YES |
| @handle watermark | **Center of image, below brand icon** (30% opacity). On **vertical divider** for comparison split-panel | YES |
...
| Brand icon position | Center of image, above watermark |
...
| Watermark wrong position | Center of image, below brand icon (30% opacity). Vertical divider for comparison split-panel |
