...
- Override: user says "pakai Bahasa" / "in Indonesian" / specifies single language → switch to that language for both headline and subtitle

Bilingual (English + Bahasa Indonesia) is the DEFAULT. No special trigger needed.
