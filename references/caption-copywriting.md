...
Captions default to **English** for all platforms. Bahasa Indonesia or other language only when user explicitly requests.
...
- [ ] In-image text: English headline + Bahasa subtitle (bilingual default). Single language on user request
- [ ] No cross-platform watermarks (IG deprioritizes TikTok watermarks and vice versa)
