...
Captions default to **Bahasa Indonesia** for all platforms. English or other language only when user explicitly requests.

**Important:** Captions for all 3 platforms (IG + TikTok + LinkedIn) are generated by DEFAULT with every carousel output. User can say "IG aja" or "skip LinkedIn" to filter.
...
## 8. Bahasa Indonesia Caption Conventions (DEFAULT)

Bahasa Indonesia is the DEFAULT caption language. No trigger needed — always use Bahasa unless user explicitly requests English or other language.
